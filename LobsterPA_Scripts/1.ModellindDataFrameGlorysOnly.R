...
#compile all data this needs data objects created in bio.lobster
...
#add in temperature from glorys
...
#do some filtering of temperature that do not make sense
...
#do some filtering of glorys that do not make sense
...
saveRDS(da,file='BaseDataForClimateModel.rds')
